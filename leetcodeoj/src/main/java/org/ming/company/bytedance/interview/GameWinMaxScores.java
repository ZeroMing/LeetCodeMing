...
public class GameWinMaxScores {
     ...
     * 1) A,2,3,4....10,J,Q,K分别对应1到13这些数字，大小王对应 0
     * 2) 游戏人数为 2人，轮流从牌堆里摸牌，每次摸到的牌只有“保留”和“使用”两个选项，且当前轮必须做出选择
    ...
    public static int gameWinMaxScores() {
